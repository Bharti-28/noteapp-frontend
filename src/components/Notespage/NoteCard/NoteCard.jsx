...
//   import notebg from "../../../assets/note_bg.png";
  ...
  export default function NoteCard({ title, body, user, _id }) {
    ...
    return (
      <Card backgroundImage={" https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9KZnSK9Cen_OPKvkpNf55Q-xJ68SqBDTqNA&usqp=CAU"}>
        <CardBody>
          <VStack>
...
//   https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9KZnSK9Cen_OPKvkpNf55Q-xJ68SqBDTqNA&usqp=CAU